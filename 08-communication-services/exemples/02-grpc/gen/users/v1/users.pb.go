...
const file_users_v1_users_proto_rawDesc = "" +
	...
	"\tListUsers\x12\x1a.users.v1.ListUsersRequest\x1a\x0e.users.v1.User0\x01B*Z(github.com/acme/app/gen/users/v1;usersv1b\x06proto3"
...
var file_users_v1_users_proto_depIdxs = []int32{
	...
	1, // 2: users.v1.UserService.GetUser:output_type -> users.v1.User
	1, // 3: users.v1.UserService.ListUsers:output_type -> users.v1.User
